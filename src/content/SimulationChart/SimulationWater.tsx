            ...
            >
                ...
                <Box display="flex" alignItems="center" marginTop={"10px"}>
                    <AvatarWrapper>
                        <img
                            alt="ADA"
                            src="/static/images/placeholders/logo/agua.png"
                        />
                    </AvatarWrapper>
                    <Box>
                ...
                <Typography>
                    <b>Valor normal: </b> <Text color="success"><b>0-600</b></Text>
                </Typography>
                <Typography>
                    <b>Valor contaminado: </b> <Text color="error"><b>600-1200</b></Text>
                </Typography>
                <Box
                    sx={{
                        display: 'flex',
